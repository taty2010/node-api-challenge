...
- [ ] Describe Middleware?
Functions that are executed in the order they are introduced.

- [ ] Describe a Resource?
Resource is the information the client is trying retrieve from the api.

- [ ] What can the API return to help clients know if a request was successful?
a .status() method as well as a .json() message 
